/**
 ******************************************************************************
 * @file      startup_stm32n657x0hxq_fsbl.s
 * @author    Auto-generated by STM32CubeIDE
 * @brief     STM32N657X0HxQ device vector table for GCC toolchain.
...
/******************************************************************************
*
* The STM32N657X0HxQ vector table.  Note that the proper constructs
...
g_pfnVectors:
  ...
  .word	0                          			/* Reserved                                                      */
  .word	WDGLS_EARLY_IRQHandler     			/* Independent watchdog interrupt                                */
  .word	WWDG_EARLY_IRQHandler      			/* Window watchdog interrupt                                     */
  ...
  .word	ADC12_IRQHandler           			/* ADC1/ADC2 global interrupt                                    */
  .word	CSI_DBG_IRQHandler         			/* CSI global interrupt                                          */
  ...
  .word	NPUCACHE_IRQHandler        			/* ATON interrupt cache                                          */
  ...
  .word	GPU2D_ERROR_IRQHandler     			/* GPU2D global interrupt                                        */
  .word	GPU_CACHE_IRQHandler       			/* GPU cache interrupt                                           */
  ...
  .word	SAI2_global_B_IRQHandler   			/* SAI2 global interrupt B                                       */
  ...
  .word	UCPD_IRQHandler            			/* UCPD global interrupt                                         */
  .word	OTG1_IRQHandler            			/* USB OTG1 HS global interrupt                                  */
  .word	OTG2_IRQHandler            			/* USB OTG2 HS global interrupt                                  */
  ...
  .word	CTI0_IRQHandler            			/* Debug monitor (Cortex-M55 related)                            */
  .word	CTI1_IRQHandler            			/* Debug monitor (Cortex-M55 related)                            */
  .word	0                          			/* Reserved                                                      */
...
*******************************************************************************/
	...
	.weak	WDGLS_EARLY_IRQHandler
	.thumb_set WDGLS_EARLY_IRQHandler,Default_Handler

	.weak	WWDG_EARLY_IRQHandler
	.thumb_set WWDG_EARLY_IRQHandler,Default_Handler
	...
	.weak	CSI_DBG_IRQHandler
	.thumb_set CSI_DBG_IRQHandler,Default_Handler
	...
	.weak	NPUCACHE_IRQHandler
	.thumb_set NPUCACHE_IRQHandler,Default_Handler
	...
	.weak	GPU2D_ERROR_IRQHandler
	.thumb_set GPU2D_ERROR_IRQHandler,Default_Handler

	.weak	GPU_CACHE_IRQHandler
	.thumb_set GPU_CACHE_IRQHandler,Default_Handler
	...
	.weak	SAI2_global_B_IRQHandler
	.thumb_set SAI2_global_B_IRQHandler,Default_Handler
	...
	.weak	UCPD_IRQHandler
	.thumb_set UCPD_IRQHandler,Default_Handler

	.weak	OTG1_IRQHandler
	.thumb_set OTG1_IRQHandler,Default_Handler

	.weak	OTG2_IRQHandler
	.thumb_set OTG2_IRQHandler,Default_Handler
	...
	.thumb_set CTI0_IRQHandler,Default_Handler

	.weak	CTI1_IRQHandler
	.thumb_set CTI1_IRQHandler,Default_Handler
